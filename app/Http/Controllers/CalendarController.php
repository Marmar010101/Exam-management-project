...
class CalendarController extends Controller
{
    ...
    {
        // Get all groups
        $groups = Group::withCount(['exams' => function($query) {
            $query->where('is_batch_created', true);
            ...
            $exams = Exam::where('group_id', $group['id'])
                ...
                ->map(function($exam) {
                    ...
                    return [
                        ...
                        'exam_time' => $exam->exam_time ? Carbon::parse($exam->exam_time)->format('H:i') : '08:00',
    ...
    public function exportPdf(Request $request)
    {
        try {
            ...
            // Use your existing blade file (check the exact name)
