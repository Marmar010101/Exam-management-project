...
return Inertia::render('Teacher/Dashboard'); // Ensure this matches your JSX component path
...
/*Route::get('/complaint', [TeacherController::class, 'showComplaintForm'])->name('complaint.form');
    Route::post('/complaint', [TeacherController::class, 'submitComplaint'])->name('complaint.submit');
    Route::get('/complaints', [TeacherController::class, 'myComplaints'])->name('complaints.index');
    */
    // Exam routes with notifications
...
// Responsable routes for handling complaints
...
// Head Department Routes - COMPLETE VERSION
