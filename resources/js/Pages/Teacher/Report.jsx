...
import { FileBarChart, Calendar, BookOpen, Clock, User } from 'lucide-react';

export default function Report({ stats, exams, modules }) {
    return (
            ...
            <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-gray-600">
                        Your teaching activities and exam schedule
                    </p>
                </div>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 mt-1">
                                                    Group: {exam.group} • Type: {exam.type}
                                                </p>
                                            </div>
