...
export default function TeacherRequests({ requests = [] }) {
    ...
    const handleStatusUpdate = (requestId, newStatus) => {
        if (confirm(`Are you sure you want to ${newStatus} this request?`)) {
            ...
            form.method = 'POST';
            form.action = route('headdepartment.teacher-requests.updateStatus', requestId);
    ...
    const handleDelete = (requestId) => {
        if (confirm('Are you sure you want to delete this request?')) {
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = route('headdepartment.teacher-requests.destroy', requestId);
    ...
    return (
        <AuthenticatedLayout header="Teacher Requests Management - Head Department">
            <Head title="Teacher Requests Management - Head Department" />
            ...
            <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Manage and respond to teacher requests</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200">
                    <div className="px-6 py-4 border-b border-gray-200">
                        <h2 className="text-xl font-bold text-gray-900">All Teacher Requests</h2>
                    </div>
                                    ...
                                    <tr>
                                        <td colSpan="7" className="px-6 py-12 text-center">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <p className="text-gray-500 text-lg font-medium">No teacher requests found</p>
